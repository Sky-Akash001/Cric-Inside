...
def result(request):
    ...
    d1 = {'Sunrisers Hyderabad':1,'Mumbai Indians':2,'Delhi Capitals':3,'Chennai Super Kings':4,'Kolkata Knight Riders':5,'Royal Challengers Bangalore':6,'Kings XI Punjab':7,'Rajasthan Royals':8,}
